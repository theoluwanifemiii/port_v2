...
function buildItems(pool: DomeGalleryImage[], seg: number): BuiltItem[] {
  ...
  // Avoid repeats right next to each other when the pool is small.
...
export default function DomeGallery({
  ...
  const rootStyle = useMemo(
    () =>
      ({
        ["--segments-x" as any]: String(segments),
        ["--segments-y" as any]: String(segments),
        ["--overlay-blur-color" as any]: overlayBlurColor,
        ["--tile-radius" as any]: imageBorderRadius,
        ["--enlarge-radius" as any]: openedImageBorderRadius,
        ["--image-filter" as any]: grayscale ? "grayscale(1)" : "none",
      }) satisfies CSSProperties,
    [grayscale, imageBorderRadius, openedImageBorderRadius, overlayBlurColor, segments]
  );
  ...
  return (
    <div ref={rootRef} className="sphere-root" style={rootStyle}>
      <main ref={mainRef} className="sphere-main">
        ...
        {children ? <div className="dg-ui">{children}</div> : null}
